...
var CoreComment = (function () {
    function CoreComment(parent, init) {
        ...
        if (init.hasOwnProperty("bgColor")) {
            this._bgColor = init["bgColor"];
        }
    }
    ...
    Object.defineProperty(CoreComment.prototype, "bgColor", {
        get: function () {
        ...
        set: function (b) {
            this._bgColor = b;
            if (this._bgColor) {
                this.dom.style.backgroundColor = this._bgColor;
            } else {
